...
> **Committed copy.** Source of truth lives at the portfolio workspace root,
> above all repos; this copy exists so sessions in this repo can see and
> follow the rules. This repo hosts two of the six portfolio projects:
> **mena** (workstreams 1–2) and **maruf** (workstream 5) — see
